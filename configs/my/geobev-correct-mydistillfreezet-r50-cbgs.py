...
test_teacher=False
# test_teacher=True
load_from = 'work_dirs/geobev-correct-mydistill-r50-cbgs/epoch_5_ema_as_teacher.pth'
model = dict(
    type='GeoBEVMyDistillFreezeT',
    scale_num=2,
    loss_distill_weight=10,
    ...
    t_model=dict(
        ...
        #     checkpoint='work_dirs/geobev-correct-mydistill-r50-cbgs/epoch_5_ema.pth',
        #     map_location='cpu'),
        scale_num=2,
        loss_distill_weight=10,
        test_teacher=True,
        ...
        img_neck=dict(
            ...
            out_ids=[0]),
        img_view_transformer=dict(
            type='RCSampleInBoxMyDistillCorrectForT',
            scale_num=2,
            keep_threshold=0.1,
            grid_config=grid_config,
            test_teacher=True,
...
custom_hooks = [
    dict(
        ...
        init_updates=10560,
        priority='NORMAL',
        # resume='work_dirs/geobev-correct-mydistill-r50-cbgs/epoch_5_ema.pth',
    ),
    # dict(
